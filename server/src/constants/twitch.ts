// Twitch badge UUID mappings - sourced from https://codeberg.org/Schkullie/Twitch-badges-cheat-sheet
export const kTwitchBadgeMapping: Record<string, string> = {
  // Global Badges
...
export const kSubGifterBadgeMapping: Record<string, string> = {
...
// Bits badge mappings (version determines which badge)
export const kBitsBadgeMapping: Record<string, string> = {
